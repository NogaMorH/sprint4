...
export const FormAdd = ({ groupId }) => {
    ...
    return (
        <form className={`form-add ${formAdd.isAddGroup ? 't-form' : 'c-form'}`}
            onSubmit={formAdd.isAddGroup ? onAddGroup : onAddTask}>
            <div className='title'>
                <textarea
            ...
            <div className="form-add-buttons">
                <button className={`add-btn ${!formAdd.isAddGroup && 'c-btn'}`}>
                    {formAdd.isAddGroup ? 'Add list' : 'Add card'}
                </button>
                <button className={`icon ${formAdd.isAddGroup ? 't-icon' : 'c-icon'}`} onClick={closeForm}>
                    <IoCloseOutline />
                </button>
            </div>
        </form >
