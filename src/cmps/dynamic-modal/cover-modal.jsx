...
export const CoverModal = ({ taskId, groupId, closeModal, className }) => {
    ...
    return (
        <div className={`dynamic-modal cover-modal-container ${className ? className : "details-pos"}`} onClick={(ev) => ev.stopPropagation()}>

            <div className="dynamic-header">
                <h4>Cover</h4>
                <IoCloseOutline className="icon-close btn-close-cover-modal" onClick={closeModal} />
            </div>
            ...
            <div className="cover-modal-color-container">
                ...
                <ul className="color-list">
                    {coverColors.map((color, idx) => {
                        return (
                            <li className="color-preview" key={idx}
            ...
            <div className="img-list-container">
                ...
                <ul className="img-list">
                    {coverImgs.map((imgUrl, idx) => {
                        return (
                            <li className="cover-img-container" key={idx}>
